  ...
  return (
    <section className="md:h-screen lg:h-screen flex  items-center flex-col lg:flex-row gap-20 lg:gap-32 py-12">
      <div className="lg:w-3/5 flex flex-col justify-center">
        ...
        <p className="text-lightgrey mt-10 mb-8">
      ...
      <div className="lg:w-2/5 lg:h-full grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 grid-rows-2 sm:grid-rows-none lg:grid-rows-3 lg:gap-x-12 gap-6">
        <Image
